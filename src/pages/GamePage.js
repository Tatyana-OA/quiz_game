...
const GamePage = () => {
  ...
  return (
    ...
    <div className="flex flex-col items-center relative">
      <p className="h-20 w-20 flex justify-center items-center border-8 border-purple-500 rounded-full my-4 
      text-3xl text-purple-500">{timeLeft}</p>
      <p className="absolute top-4 left-4 text-2xl text-purple-500">Score: {score}</p>
      <p className="absolute top-4 right-4 text-2xl text-purple-500">Questions: {currentQuestionIndex}/10</p>
