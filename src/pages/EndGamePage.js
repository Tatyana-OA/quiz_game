...
const restartHandler = () => {
  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <p className="text-2xl mb-4">Your score is: <span className="text-purple-800">{score}</span>/10</p>
      <Button onClick={restartHandler}>Restart Game</Button>
        <div className="mt-4 p-4">
      {answers.map((answer, index) => (
        <div key={index} className="border-b-2 border-purple-500 flex justify-between">
